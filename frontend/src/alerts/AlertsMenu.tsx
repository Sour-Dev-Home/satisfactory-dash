  ...
  return (
    <div className="grid gap-4">
      <div className="flex items-center justify-between gap-3">
        ...
        <Link to="/app/settings#alerts" onClick={onNavigate} className="inline-flex min-h-[44px] items-center text-sm">
          Manage alerts
        </Link>
      </div>
  ...
  return (
    <div className="rounded-md border border-line">
      <button
        ...
        onClick={() => setOpen((o) => !o)}
        className="grid min-h-[44px] w-full gap-0.5 rounded-md border-0 bg-transparent px-3 py-2 text-left font-normal"
      >
        <span>
