 ...
 *
 * ADR-0031: moved out of powerService.ts (unchanged) so the derivation that applies it to an agent's readings
 * (snapshotDerive.ts) and the power service can both import it without a cycle.
 */
