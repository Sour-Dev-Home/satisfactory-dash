...
import { AgentStatusResponseSchema, EnrollmentCodeResponseSchema, RevokeAgentResponseSchema, ServerIdSchema, endpoints } from "@satisfactory-dash/shared";
 ...
 */
export function createAgentUserRouter(service: AgentsService): Router {
  const router = Router();
