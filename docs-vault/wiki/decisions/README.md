...
| [0025](./0025-postgres-and-google-sign-in.md) | **Accepted (decision 7, the query layer, is open):** Postgres, Google sign-in and the DB registry, the ADR-0020 phase 1 build plan; PRs 1-2 may start, PR 3 onward waits on decision 7 |
